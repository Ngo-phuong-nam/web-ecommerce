...
<head>
    ...
    <title>web_ecommerce</title>
    <link rel="icon" href="{{ asset('public/fontend/img/Fevicon.png') }}" type="image/png'">
    ...
    <header class="header_area">
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    <a class="navbar-brand logo_h" href="index.html"><img src="{{URL::to('public/fontend/img/logo.png')}}" alt=""></a>
                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
                            ...
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="{{ URL::to('/shop-category') }}">Shop
                                            Category</a></li>
                                    <li class="nav-item"><a class="nav-link" href="{{ URL::to('/product-checkout') }}">Product
                                            Checkout</a></li>
                                    <li class="nav-item"><a class="nav-link" href="{{ URL::to('/confirmation') }}">Confirmation</a></li>
                                    <li class="nav-item"><a class="nav-link" href="{{ URL::to('/shopping-cart') }}">Shopping
                                            Cart</a></li>
                                </ul>
                            </li>
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="{{ URL::to('/blog-details') }}">Blog
                                            Details</a></li>
                                </ul>
                            </li>
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="{{ URL::to('/login') }}">Login</a>
                                    </li>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <div class="single-footer-widget instafeed">
                            ...
                            <ul class="list instafeed d-flex flex-wrap">
                                <li><img src="{{ URL::to('public/fontend/img/gallery/r1.jpg') }}" alt=""></li>
                                <li><img src="{{ URL::to('public/fontend/img/gallery/r2.jpg') }}" alt=""></li>
                                <li><img src="{{ URL::to('public/fontend/img/gallery/r3.jpg') }}" alt=""></li>
                                <li><img src="{{ URL::to('public/fontend/img/gallery/r5.jpg') }}" alt=""></li>
                                <li><img src="{{ URL::to('public/fontend/img/gallery/r7.jpg') }}" alt=""></li>
                                <li><img src="{{ URL::to('public/fontend/img/gallery/r8.jpg') }}" alt=""></li>
                            </ul>
                        </div>
                    </div>
