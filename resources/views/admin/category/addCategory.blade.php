...
<div class="container-fluid">
    <div class="card shadow mb-4 p-4">
        ...
        <form method="post" role="form" action="{{route('postCategory')}}">
            {{csrf_field()}}
            <div class="form-group">
                <label for="exampleFormControlInput1" class="p-2">Tên danh mục</label>
                <input type="text" name="category_name" class="form-control" id="exampleFormControlInput1" placeholder="Tên danh mục...">
            </div>
            <div class="form-group">
                <label for="exampleFormControlTextarea1" class="p-2">Mô tả</label>
                <textarea name="category_desc" class="form-control" id="exampleFormControlTextarea1" rows="4"></textarea>
            </div>
            <div class="form-group">
