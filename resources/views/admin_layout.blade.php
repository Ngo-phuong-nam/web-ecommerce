        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" href="{{route('getLogout')}}">Logout</a></li>
                </ul>
            </li>
        </ul>
    </nav>
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="{{URL::to('admin/add-category')}}">Thêm danh mục</a>
                                <a class="nav-link" href="{{URL::to('admin/list-category')}}">Liệt kê</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="{{URL::to('admin/add-brand')}}">Thêm thương hiệu</a>
                                <a class="nav-link" href="{{URL::to('admin/list-brand')}}">Liệt kê</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="{{URL::to('admin/add-product')}}">Thêm sản phẩm</a>
                                <a class="nav-link" href="{{URL::to('admin/list-product')}}">Liệt kê</a>
                            </nav>
                        </div>
